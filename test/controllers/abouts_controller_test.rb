...
class AboutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create about" do
    assert_difference('About.count') do
      post abouts_url, params: { about: { context: @about.context, name: @about.name, title: @about.title } }
    end
  ...
  test "should update about" do
    patch about_url(@about), params: { about: { context: @about.context, name: @about.name, title: @about.title } }
