...
class AboutUsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create about_u" do
    assert_difference('AboutU.count') do
      post about_us_url, params: { about_u: { context: @about_u.context, name: @about_u.name, title: @about_u.title } }
    end
  ...
  test "should update about_u" do
    patch about_u_url(@about_u), params: { about_u: { context: @about_u.context, name: @about_u.name, title: @about_u.title } }
